...
<?php 
    include('dbcon.php');
    $user = htmlspecialchars($_GET["shopid"]);

    $_SESSION['user_id'] = $user;

	$result=mysqli_query($con, "SELECT*FROM `retail products` where `shopid`='".$_SESSION['user_id']."' AND `rights`='Admin'")or die('Error In Session1'.mysqli_error($con));
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo $fetch['shop'] ;?></h6>
                        <span>Admin</span>
                    </div>
                </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
							...
							<?php  while($row= $result->fetch_assoc()){?>
                              <tr>
                                ...
                                <td id='product_quantity'><?php echo 'n/a';?></td>
