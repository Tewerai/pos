...
<?php include('session.php'); include('dbcon.php'); 
    ...
    //echo date('l jS \of F Y',strtotime("-1 days"));
  
   $result=mysqli_query($con, "SELECT*FROM `retailers history` where `shopid`='".$_SESSION['user_id']."' AND
  `date`='$date' AND `order-status`='complete'")or die('Error In Session 1'.mysqli_error($con));
  ...
  `date`='$date'")or die('Error In Session1'.mysqli_error($con));
   ...
   while($r= $result->fetch_assoc()){ $total += $r['amount'];}
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3" id='catalogue'>
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <div class="ms-3">
                                <p class="mb-2">SELECT FROM CATALOGUE</p>
                                <h6 class="mb-0">Click to select from an already made list of items.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3" id='add'>
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <div class="ms-3">
                                <p class="mb-2">ADD MANUALLY</p>
                                <h6 class="mb-0">Click here to add items manually</h6>
                            </div>
                        </div>
                    </div>
                </div>
